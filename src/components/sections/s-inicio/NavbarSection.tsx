...
const NavbarComponent = () => {
  return (
    <div className="w-screen h-20 shadow-xl rounded-b-2xl fixed top-0 left-0 flex flex-col align-center justify-around hover:h-40 group duration-500  transition-all">
      <div className="w-screen h-full flex align-center justify-around  group-hover:h-1/2 duration-500 transition-all">
        <LogoWrapper />
        <SearchBar />
        <PerfilTrigger />
      </div>

      <div className="w-screen h-0 flex align-center justify-start pl-20 group-hover:min-h-20 duration-500 transition-all relative">
