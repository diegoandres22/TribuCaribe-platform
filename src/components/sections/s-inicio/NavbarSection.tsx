...
export const NavbarComponent = () => {
  ...
  return (
    ...
    >
      <div className="w-screen h-20 absolute top-0 flex align-center justify-around  duration-500 transition-all z-50">
        <LogoWrapper />
        <SearchBar />
        <PerfilTrigger />
      </div>
      ...
      <div
        className={`${childrenTwoLg} w-screen h-20 flex align-center justify-start  duration-500 transition-all absolute bottom-0 z-50`}
      >
        <div
